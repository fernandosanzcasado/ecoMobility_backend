...
const registerSchema = [check('email').notEmpty().withMessage("Email field can't be empty.").trim().isEmail().withMessage("The email field must have an email structure").normalizeEmail(),
